...
func RegisterAppHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AppServer) error {
	...
	mux.Handle("POST", pattern_App_HandleAppDomain_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/api.eng.v1.App/HandleAppDomain", runtime.WithHTTPPathPattern("/v1/app/domain"))
		if err != nil {
...
func RegisterAppHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AppClient) error {
	...
	mux.Handle("POST", pattern_App_HandleAppDomain_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/api.eng.v1.App/HandleAppDomain", runtime.WithHTTPPathPattern("/v1/app/domain"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_App_HandleAppDomain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "app", "domain"}, ""))
